...
class _TimeoutBoundRunnable(Runnable):
    ...
    def invoke(self, input: Any, config: RunnableConfig | None = None, **kwargs: Any) -> Any:
        ...
        fut = _pool.submit(self._runnable.invoke, input, config, **kwargs)
        try:
...
class TimeoutBoundLLM(Runnable):
    ...
    def invoke(self, input: Any, config: RunnableConfig | None = None, **kwargs: Any) -> Any:
        ...
        effective = _effective_timeout(self._timeout)
        fut = _pool.submit(self._llm.invoke, input, config, **kwargs)
        try:
            return fut.result(timeout=effective)
        except FuturesTimeoutError as e:
            fut.cancel()
    ...
    def bind(self, **kwargs: Any) -> _TimeoutBoundRunnable:
    ...
    def with_structured_output(self, schema: Any, **kwargs: Any) -> _TimeoutBoundRunnable:
        return _TimeoutBoundRunnable(
            self._llm.with_structured_output(schema, **kwargs), self._timeout
        )
